...
public class smc_bus_informationActivity extends AppCompatActivity {

    private final String TAG = "myTag";
    private final String key = "XqRDS+irNq7AVRFOs6yVP2h3nUWyIlGNkSxMb6KIS784wf/L5plODXcIy4TNrXElguC6NC1RzOGpvl57u6UWWA==";
    //private final String key = "XqRDS%2BirNq7AVRFOs6yVP2h3nUWyIlGNkSxMb6KIS784wf%2FL5plODXcIy4TNrXElguC6NC1RzOGpvl57u6UWWA%3D%3D";
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.d(TAG, car2 + " " + min2 + " " + station1);
                        if(car1 == null) {
                            buffer.append("도착 정보 없음");
                        } else {
                            buffer.append("첫번째 차량 도착 정보\n");
                            buffer.append("차랑 번호 : " + car1 + "\n");
